# mobile-dashboard-verify

## Purpose

Vista móvil del dashboard (lista + detalle) con verificación individual como flujo principal en viewports por debajo del breakpoint `md`.
